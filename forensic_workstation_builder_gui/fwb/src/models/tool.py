...
class Tool:
    ...
    category: str
    version: str
    supported_os: List[str]  # List of OSType values
    
    # Installation details
    install_method: str  # InstallMethod value
    download_url: str
    sha256: Optional[str] = None
    
    # Optional fields
    dependencies: List[str] = None  # List of tool IDs
    file_name: Optional[str] = None  # Name after download
